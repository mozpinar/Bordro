...
type
  ...
  IBaseDictionary = Interface
    ...
    procedure AssignGridColumnTitles(const AFormName : string; aDBGrid : TJvDBGrid);
  end;
...
type
  ...
  public
    ...
    procedure AssignGridColumnTitles(const AFormName : string; aDBGrid : TJvDBGrid); virtual; abstract;
  end;
...
{$REGION TLanguageDictionaryFactory}
  ...
  private
    class var FDictionary: IDictionary<TLanguageDictionaryType, TLanguageDictionaryFunction>;
  public
  ...
  begin
    FDictionary := TCollections.CreateDictionary<TLanguageDictionaryType, TLanguageDictionaryFunction>;
  end;
